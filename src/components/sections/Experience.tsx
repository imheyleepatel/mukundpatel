      ...
      <div className="mt-14 relative">
        ...
        <div className="relative grid md:grid-cols-2 gap-8 items-start">
          <div className="md:text-right md:pr-12">
            ...
            <h3 className="mt-2 text-2xl font-display font-bold text-primary">Head — HVAC Division</h3>
            <p className="mt-1 text-muted-foreground flex items-center gap-2 md:justify-end">
              <Briefcase className="h-4 w-4" /> Linc Digital Systems Pvt. Ltd.
            </p>
            <p className="mt-1 text-sm text-muted-foreground flex items-center gap-2 md:justify-end">
              <MapPin className="h-4 w-4" /> Ahmedabad, India
            </p>
          </div>
          ...
          <span className="md:hidden absolute left-4 top-2 -translate-x-1/2 h-4 w-4 rounded-full bg-accent ring-4 ring-secondary" />

          <div className="md:pl-12 pl-12 md:pl-12">
            <div className="bg-card border border-border rounded-xl p-6 shadow-card">
              <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-3">Key Responsibilities</p>
